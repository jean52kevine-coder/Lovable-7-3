...
const timelineData = [
  {
    ...
    title: "Découverte",
    date: "Jour 1-2",
    content: "Consultation gratuite pour comprendre votre activité, vos objectifs et votre marché cible.",
    category: "Planning",
    icon: Calendar,
    relatedIds: [2],
  ...
  },
  {
    ...
    title: "Support",
    date: "30 jours",
    content: "Formation à l'utilisation et support inclus pour vous accompagner après le lancement.",
    category: "Support",
    icon: Headphones,
    relatedIds: [4],
    status: "pending" as const,
