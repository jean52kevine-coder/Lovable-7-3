...
export function FeatureCard({ feature, className, ...props }: FeatureCardProps) {
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-lg border border-border bg-card p-6 md:p-8 transition-all duration-300 hover:border-primary/50 hover:shadow-card-hover",
        className
      )}
      {...props}
    >
