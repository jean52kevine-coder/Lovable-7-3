  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-stretch">
        ...
        <div className="relative lg:col-span-3 pt-6">
          <div className="flex justify-center mb-4">
            <PopularBadge />
          </div>
          <div className="relative w-full bg-[#0d1a0d] border-2 border-[#1DB954]/50 shadow-[0_0_50px_rgba(29,185,84,0.1)] rounded-2xl p-8 flex flex-col gap-6 group">
