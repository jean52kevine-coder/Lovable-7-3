    ...
    <section className="py-[100px]" style={{ backgroundColor: "hsl(var(--section-alt-bg))" }}>
      <div className="section-container">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-[680px] mx-auto rounded-2xl p-8 md:p-10"
          ...
          <div className="space-y-6 mb-8">
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg px-4 py-3 text-sm font-dm bg-background border border-border text-foreground focus:border-primary focus:outline-none"
              >
            ...
            <div>
              ...
              <input
                ...
                style={{
                  background: `linear-gradient(to right, hsl(145, 63%, 42%) 0%, hsl(145, 63%, 42%) ${((valeurClient - 50) / 2950) * 100}%, rgba(255,255,255,0.1) ${((valeurClient - 50) / 2950) * 100}%, rgba(255,255,255,0.1) 100%)`
                }}
              />
  ...
  <Layout>
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="section-container text-center relative z-10">
        <TextSplit className="heading-display text-4xl md:text-6xl mb-6" as="h1">POURQUOI AVOIR UN SITE WEB ?</TextSplit>
            ...
            {roiTestimonials.map((t, i) => (
              <motion.div key={i} variants={itemVariants}>
                <div className="rounded-xl p-6 h-full" style={{ backgroundColor: "#111811", border: "1px solid #1a2e1a" }}>
                  ...
                  <span
                    className="inline-block text-[12px] font-semibold px-3 py-1 rounded-full text-primary mb-4"
