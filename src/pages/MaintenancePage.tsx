      ...
      <div className="relative z-10 container mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-10">
        <div className="text-center lg:text-left flex-1">
          ...
          <BlurReveal delay={0.1}>
            <h1 className="heading-display font-clash text-4xl md:text-6xl mb-4">
      ...
      <div className="section-container">
        ...
        <ScaleSection>
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.15}>
            {formules.map((f, i) => (
              <motion.div key={i} variants={itemVariants} className="relative w-full pt-6">
                {f.highlighted && (
                  <div className="flex justify-center mb-4">
                    <PopularBadge />
                  </div>
                )}
                <div className={`relative w-full rounded-2xl p-8 flex flex-col gap-6 transition-all duration-300 group ${f.highlighted ? "bg-[#0d1a0d] border-2 border-[#1DB954]/50 shadow-[0_0_50px_rgba(29,185,84,0.1)]" : "bg-[#0d130d] border border-[#1a2e1a] hover:border-[#1DB954]/30 hover:shadow-[0_0_40px_rgba(29,185,84,0.08)]"}`}>
