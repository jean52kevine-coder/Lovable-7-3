...
const MaintenancePage = () => {
  ...
  <Layout>
    <SEOHead
      title="Maintenance Site Web dès 39€/mois — Sans Engagement | ALTÉRA"
      description="Maintenance de site web à partir de 39€/mois. Mises à jour, sauvegardes, monitoring 24/7, support réactif. Sans engagement. Pour sites artisans et PME Grand Est."
      canonical="https://altera.fr/services/maintenance"
