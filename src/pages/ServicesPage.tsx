...
const ServicesPage = () => (
  <Layout>
    <SEOHead
      title="Nos Services Web — Vitrine, E-commerce, Maintenance | ALTÉRA"
      ...
      canonical="https://altera.fr/services"
      keywords="services web Grand Est, création site artisan, site vitrine PME, e-commerce Grand Est"
    />
