  ...
  <Layout>
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="section-container text-center relative z-10">
        ...
        <BlurReveal delay={0.5}><p className="font-dm text-lg max-w-xl mx-auto text-muted-foreground">Présentez votre activité avec un site moderne qui inspire confiance et attire de nouveaux clients.</p></BlurReveal>
      </div>
    </section>
