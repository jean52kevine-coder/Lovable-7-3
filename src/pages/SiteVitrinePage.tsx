...
const profils = [
  {
    emoji: "🔧",
    name: "Mohammed, plombier à Lyon",
    text: "Avant son site : 100% de ses clients venaient du bouche-à-oreille. Après : il reçoit entre 6 et 10 demandes de devis en ligne chaque mois. Son site travaille pendant qu'il est sur chantier.",
  },
  {
    emoji: "🌸",
    name: "Sophie, fleuriste à Bordeaux",
    text: "Ses clientes trouvent maintenant ses horaires, ses créations et son adresse en quelques secondes sur Google. Plus besoin d'expliquer où elle est à chaque appel.",
  },
  {
    emoji: "🧘",
    name: "Claire, ostéopathe à Nantes",
    text: "Un site professionnel rassure ses nouveaux patients avant même le premier rendez-vous. Elle reçoit ses demandes de RDV directement par email via son formulaire.",
  },
];
      ...
      <div className="section-container">
        <BlurReveal className="text-center mb-14">
          <h2 className="heading-display text-2xl md:text-3xl">
            COMMENT ÇA <span className="text-primary">SE PASSE ?</span>
          </h2>
        </BlurReveal>
        ...
        <div ref={ref} className="relative max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            style={{ backgroundColor: "hsl(145, 63%, 42%)", scaleY, height: "100%" }}
          />
  ...
  <Layout>
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="section-container flex flex-col lg:flex-row items-center gap-10 relative z-10">
        <div className="text-center lg:text-left flex-1">
          ...
          <BlurReveal delay={0.4}><p className="text-primary heading-display text-3xl mb-4">497 €</p></BlurReveal>
          <BlurReveal delay={0.5}><p className="font-dm text-lg max-w-xl mx-auto lg:mx-0 text-muted-foreground">Présentez votre activité avec un site moderne qui inspire confiance et attire de nouveaux clients.</p></BlurReveal>
        </div>
    ...
    <section className="py-[100px]" style={{ backgroundColor: "hsl(var(--section-alt-bg))" }}>
      <div className="section-container">
        <BlurReveal className="text-center mb-14">
          <h2 className="heading-display text-2xl md:text-3xl">
            FAITS POUR DES GENS <span className="text-primary">COMME VOUS</span>
          </h2>
        </BlurReveal>
        <ScaleSection>
