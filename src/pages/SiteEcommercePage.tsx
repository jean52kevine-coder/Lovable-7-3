    ...
    <section className="relative min-h-[65vh] flex items-center overflow-hidden bg-[#0a0f0a]">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 md:py-24 flex flex-col md:flex-row items-center gap-10">
        <div className="text-center lg:text-left flex-1">
          ...
          <BlurReveal delay={0.4}><p className="text-base sm:text-lg md:text-xl text-white/55 mt-6 max-w-xl leading-relaxed mx-auto lg:mx-0" style={{fontFamily:"'DM Sans', sans-serif"}}>Vendez vos produits en ligne avec une boutique performante, sécurisée et facile à gérer.</p></BlurReveal>
