    ...
    <AnimatedSection className="section-padding bg-background">
      <div className="section-container text-center">
        ...
        <h1 className="heading-display text-4xl md:text-6xl mb-4">
          Site <span className="text-gradient">E-commerce</span>
        </h1>
    ...
    <AnimatedSection className="section-padding bg-card">
      <div className="section-container text-center">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          Le e-commerce en France croît de 15% par an. Vos clients achètent en ligne — soyez là où ils cherchent.
        </p>
      </div>
    </AnimatedSection>
    ...
    <AnimatedSection className="section-padding bg-card">
      <div className="section-container text-center">
        <h2 className="heading-display text-2xl md:text-4xl mb-6">
          Lancez votre <span className="text-gradient">boutique en ligne</span>
        </h2>
